...
class MainActivity : AppCompatActivity() {
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun doInBackground(vararg params: String?): String? {
            ...
            try {
                response =
                    URL("https://api.openweathermap.org/data/2.5/weather?q=${Companion.CITY}&units=metric&appid=${Companion.API}")
                        .readText(
                            Charsets.UTF_8
                        )
            } catch (e: Exception) {
    ...
    companion object {
        private const val CITY: String = "Tashkent"
        private const val API: String = "ff7bb1c73aad63b13c4e8c834af7e8bf"
    }
